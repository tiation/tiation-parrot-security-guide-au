...
# tiation-parrot-security - Enterprise Deployment Script
# Project Type: security-guide
...
PROJECT_NAME="tiation-parrot-security"
PROJECT_TYPE="security-guide"
DEFAULT_DOMAIN="tiation-parrot-security.surge.sh"
FEATURES="security-tools,documentation,tutorials,compliance-guides"
